...
public class XmlUtils {
    ...
    public static String beanToXml(Object obj, Class<?> load) {
        ...
        try {
            ...
            if (LOGGER.isErrorEnabled()) {
                LOGGER.error("beanToXml error，reason: ", e);
            }
        } finally {
            if (writer != null) {
                try {
                    ...
                    if (LOGGER.isErrorEnabled()) {
                        LOGGER.error("beanToXml error，close writer exception: ", e);
                    }
                }
            }
        }
    ...
    public static <T> T xml2Bean(Class<T> clazz, String xmlStr) {
        ...
        try {
            ...
            if (LOGGER.isErrorEnabled()) {
                LOGGER.error("xml2Bean error，reason: ", e);
            }
        } finally {
            if (reader != null) {
                try {
                    ...
                    if (LOGGER.isErrorEnabled()) {
                        LOGGER.error("xml2Bean error，close reader exception: ", e);
                    }
                }
            }
        }
